...
lH1 = NNLayer(20,activation=NNLayer.A_ReLU, layerType=NNLayer.T_Hidden)
lH2 = NNLayer(20,activation=NNLayer.A_ReLU, layerType=NNLayer.T_Hidden)
...
# Test data
m = 100
x, y = sklearn.datasets.make_circles(n_samples=m, shuffle=False, factor=0.3, noise=0.0001)
...
results = nnController.trainModel(x, y, maxRuns=10000, minError=None, 
                                  alpha = 0.0000125, regStrength=0.001,
