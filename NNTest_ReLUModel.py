...
#lH2 = NNLayer(50,activation=NNLayer.A_Tanh, layerType=NNLayer.T_Hidden)
...
#Y = np.zeros((m,2)) # Define target matrix
#Y[y==1,1] = 1
#Y[y==0,0] = -1
...
results = nnController.trainModel(x, y, maxRuns=2000, minError=None, 
                                  alpha = 0.00015, regStrength=0.001,
                                  gradientCheckData=None, 
                                  printRun=False,
                                  sgdRatio=0.0)
'''                               
results = nnController.trainModelSGD(x, y, maxRuns=10000, minError=0, 
                                  alpha = 0.03, regStrength=0,
                                  cvRatio=0.2,
                                  printRun=False)                                  
