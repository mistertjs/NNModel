...
Performs gradient check on Tanh network using dataset of two classes.
...
m = 200
n = lIn.getNodeCnt()
x, yc = make_classification(n_samples=200, n_features=n, n_redundant=0, n_informative=2,
